...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/OLD BOOKS_INFO.css" >
    ...
    <div class="otherBooks-F">
		...
		<label class="bookDetails">Select Book image:</label>
  		<input type="file" name="uploadfile" >
                ...
                <label class="bookDetails">gmail</label><br><input name="o_gmail" type="text" placeholder="Enter your Gmail address"><div class="space"></div><br>
                <label class="bookDetails">Your Name</label><br><input name="o_yName" type="text" placeholder="Enter Your name"><div class="space"></div><br>
